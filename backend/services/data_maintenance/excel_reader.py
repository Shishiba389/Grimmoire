...
CANONICAL_ALIASES = {
    "brand": ["brand", "brand name", "brand_name", "BRAND"],
    "status": ["status", "product status", "item status", "STATUS"],
    "sku": ["sku", "ot article number", "article number", "item code", "product code"],
    "product_name": ["product name", "name", "item name", "description"],
}
